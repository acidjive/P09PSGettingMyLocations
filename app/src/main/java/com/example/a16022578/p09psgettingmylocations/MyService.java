package com.example.a16022578.p09psgettingmylocations;
...
//     Toast.makeText(getApplicationContext(), "Service created", Toast.LENGTH_LONG).show();
            ...
            lc = new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    if(locationResult != null) {
                        ...
                        try {
                            folderLocation = Environment.getExternalStorageDirectory().getAbsolutePath() + "/P09PSGettingMyLocations";
    ...
    public void onDestroy() {
        Log.d("Service", "Service has exited");
        Toast.makeText(getApplicationContext(), "Service has exited", Toast.LENGTH_LONG).show();
